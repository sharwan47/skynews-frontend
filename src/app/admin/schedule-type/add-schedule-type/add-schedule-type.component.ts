...
@Component({
  selector: "app-add-schedule-type",
  templateUrl: "./add-schedule-type.component.html",
  styleUrls: ["./add-schedule-type.component.scss"],
})
export class AddScheduleTypeComponent implements OnInit {
  ...
  submit() {
    ...
    // this.spinner.show();
    this.adminService.createScheduleType(obj).subscribe({
      next: (res: any) => {
        // this.spinner.hide();
        let msg = "";
        let header = "";
